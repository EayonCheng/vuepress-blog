...
module.exports = {
  ...
  head: [
    ...
    ['meta', { name: 'Keywords', content: '程先生,程先生的主页,bookbook,BookBook,bookbook.cc,BookBook.cc' }],
    // 作者
    ['meta', { name: 'author', content: '程先生,程先生的主页,bookbook,BookBook,bookbook.cc,BookBook.cc' }],
    // 百度统计
    ...
    nav: [
      ...
      { text: "时间线", link: "/timeline/", icon: "reco-date" },
      {
        ...
        items: [
          ...
          {
            text: "CSDN",
            link: "https://blog.csdn.net/Eayon_C?spm=1001.2101.3001.5343",
            icon: "reco-csdn",
          },
          {
            text: "GitHub",
            link: "https://github.com/center4",
            icon: "reco-github",
          },
          {
            text: "码云",
            link: "https://gitee.com/EayonC",
            icon: "reco-mayun",
          },
        ]
      }
